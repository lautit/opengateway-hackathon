...
export class PhoneVerificationService {
   ...
   */
  static async mockedCallOrchestrator(
    fullNumber: string,
  ): Promise<VerificationResult> {
    ...
    const mockResponses: VerificationResult[] = [
      ...
      },
      {
        ...
        score: 40,
        type: "warning",
        message: "Se requiere verificación adicional. Posible cambio de SIM.",
      },
      {
        decision: "BLOQUEADO",
        score: 10,
        type: "danger",
        message: "Acceso denegado por alto riesgo de fraude.",
      },
    ];
